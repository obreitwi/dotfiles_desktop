...
getKeys = do
  ...
  return $ \ (conf@(XConfig {XMonad.modMask = modMask})) ->
    ...
    , ((modMask .|. controlMask,    xK_s        ), layoutSplitScreen 2 (Tall 1 (3/100) (1/2)))
    , ((modMask .|. controlMask,    xK_x        ), layoutSplitScreen 2 (Tall 1 (3/100) (2/3) ))
    , ((modMask .|. controlMask,    xK_e        ), layoutSplitScreen 3 (ThreeColMid 1 (3/100) (1/2)))
    , ((modMask .|. controlMask,    xK_d        ), layoutSplitScreen 3 (ThreeColMid 1 (3/100) (1/3)))
